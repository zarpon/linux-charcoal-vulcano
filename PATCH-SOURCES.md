...
- Patches com porta local continuam consultando o upstream atual. Uma alteração no SHA-256 oficial interrompe o build até que a porta seja atualizada e validada.
