...
- A série RFC de quatro patches `amd_pstate_epp_boost` usa quatro portas locais separadas para Valve 6.16.12. Cada porta é vinculada ao SHA-256 do payload canônico de sua mensagem `linux-pm`; se qualquer mensagem upstream mudar, o resolvedor falha antes do `makepkg` até que a porta correspondente seja revisada e reaplicada estritamente.
