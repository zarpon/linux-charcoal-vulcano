...
| [RFC AMD P-State: boost EPP por núcleo](https://lore.kernel.org/linux-pm/20260728073150.54964-2-void@manifault.com/t/#m22b425e7e2889c9656fe7422aa02d78d91a36431) | Porta os quatro patches para Valve 6.16.12: limpeza de kernel-doc, ordenação do cache de requisições CPPC, boost EPP por núcleo recentemente ocupado e documentação. O boost permanece desabilitado por padrão; `amd_pstate.epp_boost=1` só tem efeito no modo ativo baseado em MSR. |
