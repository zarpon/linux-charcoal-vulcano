...
main() {
  ...
  info "ZRAM switches to LZ4 with LZO-RLE priority-1 and ZSTD level-1 priority-2 recompression after booting Charcoal; the active swap is not reset during installation."
}
